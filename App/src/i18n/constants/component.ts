...
export const componentPT = {
  VALIDATION: {
    ...
    INVALIDPASSWORD: "A senha deve ter pelo menos 8 caracteres, incluindo letras maiúsculas e minúsculas",
    ...
    REQUIREDPLATE: "Placa é obrigatória",
    REQUIREDCHASSIS: "Chassi é obrigatório",
    REQUIREDMODEL: "Modelo é obrigatório",
    REQUIREDMARK: "Marca é obrigatória",
    REQUIREDCOUNTRY: "País é obrigatório",
    REQUIREDSTATE: "Estado é obrigatório",
    REQUIREDCITY: "Cidade é obrigatória",
    REQUIREDSIZE: "Tamanho é obrigatório",
  },
  LANGUAGE: {
    PT: "PT",
    EN: "EN",
...
export const componentEN = {
  VALIDATION: {
    ...
    INVALIDPASSWORD: "Password must have at least 8 characters, including uppercase and lowercase letters",
    ...
    REQUIREDCHASSIS: "Chassis is required",
    REQUIREDMODEL: "Model is required",
    REQUIREDMARK: "Brand is required",
