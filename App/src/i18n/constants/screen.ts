...
export const screenPT = {
  ...
  ROUTES: {
    ...
    FREIGHTHISTORY: "Histórico de Fretes",
  },
  FREIGHTHISTORY: {
    TITLE: "Histórico de Fretes",
    SEARCH_PLACEHOLDER: "Pesquise seus fretes",
    EMPTY_LIST: "Nenhum frete no histórico.",
  },
  TERM: {
  ...
  FREIGHT: {
    ...
    VALIDATION: {
      ...
      VEHICLE_INCOMPATIBLE: "Seu veículo não suporta o peso desta carga.",
    },
  },
  PROPOSAL: {
    ...
    SEND: "Enviar",
    LOCATION_REQUIRED: "Ative o GPS e permita o acesso à localização para enviar a proposta.",
    STATUS: "Status",
  ...
  MODALFREIGHTHISTORYFILTER: {
    ...
    SUBTITLE: "Escolha o status dos fretes exibidos na lista.",
...
export const screenEN = {
  ...
  FREIGHTHISTORY: {
    TITLE: "Freight History",
    SEARCH_PLACEHOLDER: "Search your freights",
    EMPTY_LIST: "No freight in history.",
  },
  TERM: {
  ...
  FREIGHT: {
    ...
    VALIDATION: {
      ...
      VEHICLE_INCOMPATIBLE: "Your vehicle does not support the weight of this cargo.",
    },
  },
  PROPOSAL: {
    ...
    SEND: "Send",
    LOCATION_REQUIRED: "Enable GPS and allow location access to send the proposal.",
    STATUS: "Status",
  ...
  MODALFREIGHTHISTORYFILTER: {
    ...
    SUBTITLE: "Choose the status of freights shown in the list.",
