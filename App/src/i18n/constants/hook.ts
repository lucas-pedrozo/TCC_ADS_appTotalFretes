...
export const hookPT = {
  NOTIFICATIONS: {
    ...
    IMAGEUPLOADTIMEOUT: "O envio da imagem demorou demais. Verifique a conexão e tente novamente.",
    IMAGEUPLOADRATELIMIT: "Muitas tentativas de envio. Aguarde alguns segundos e tente novamente.",
...
export const hookEN = {
  NOTIFICATIONS: {
    ...
    IMAGEUPLOADTIMEOUT: "Image upload timed out. Check your connection and try again.",
    IMAGEUPLOADRATELIMIT: "Too many upload attempts. Wait a few seconds and try again.",
